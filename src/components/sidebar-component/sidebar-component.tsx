  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Divider />
        {IconFinder.getFileIcon(
          this.props.selectedFile,
          { display: "flex", alignSelf: "center", padding: "4rem" },
          "10x"
        )}
        <Divider />
        {this.props.selectedFile.name ? (
          <div>
            <Grid
              className={classes.detailsAlignment}
              container
              spacing={3}
              classes={{
          ...
          <Typography color="textSecondary" align="center" variant="subtitle1">
            Bitte eine Datei auswählen um Details anzuzeigen
          </Typography>
        )}
      </Drawer>
    );
